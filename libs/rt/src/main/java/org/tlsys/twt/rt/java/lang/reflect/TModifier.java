...
@ReplaceClass(java.lang.reflect.Modifier.class)
public class TModifier {
    ...
    private static final int CLASS_MODIFIERS =
            TModifier.PUBLIC         | TModifier.PROTECTED    | TModifier.PRIVATE |
                    TModifier.ABSTRACT       | TModifier.STATIC       | TModifier.FINAL   |
                    TModifier.STRICT;
    ...
    private static final int INTERFACE_MODIFIERS =
            TModifier.PUBLIC         | TModifier.PROTECTED    | TModifier.PRIVATE |
                    TModifier.ABSTRACT       | TModifier.STATIC       | TModifier.STRICT;
    ...
    private static final int METHOD_MODIFIERS =
            TModifier.PUBLIC         | TModifier.PROTECTED    | TModifier.PRIVATE |
                    TModifier.ABSTRACT       | TModifier.STATIC       | TModifier.FINAL   |
                    TModifier.SYNCHRONIZED   | TModifier.NATIVE       | TModifier.STRICT;
    ...
    private static final int FIELD_MODIFIERS =
            TModifier.PUBLIC         | TModifier.PROTECTED    | TModifier.PRIVATE |
                    TModifier.STATIC         | TModifier.FINAL        | TModifier.TRANSIENT |
                    TModifier.VOLATILE;
