...
public final class TOptional<T> {
     ...
     */
    private static final TOptional<?> EMPTY = new TOptional<>();
     ...
     *
     * @implNote Generally only one empty instance, {@link TOptional#EMPTY},
     * should exist per VM.
     */
    private TOptional() {
        this.value = null;
    ...
    public static <T> TOptional<T> empty() {
        ...
        TOptional<T> t = (TOptional<T>) EMPTY;
        return t;
    }
