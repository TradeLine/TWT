...
import org.tlsys.compiler.parser.*;
...
public class Pass1 {
    ...
    private static final Logger LOG = Logger.getLogger(Pass1.class.getName());
    ...
    public void parse(Method theMethod, MethodDeclaration theMethodDecl) throws IOException {
        ...
        Block block;
        if (Compile.getInstance().reductionLevel == 0) {
    ...
    private void expressionsToVariables(Node node, boolean clone) {
        ...
        LOG.info("expressionsToVariables ...");
    ...
    public void parseStatement() throws IOException {
        ...
        while (bytes.available() > 0) {
            ...
            LOG.info(" -> " + stmt + " @ " + methodDecl.getLineNumberCursor().getLineNumber(stmt) + ", depth:" + depth + ", delta:" + stmt.getStackDelta());
...
/*
    ...
    private ASTNode parseInstruction() throws IOException {
        ...
        LOG.info(currentIndex + " " + instructionType.getName() + "[" + opcode + "] ");
        ...
        switch (opcode) {
            ...
            case Const.LOOKUPSWITCH: {
                ...
                for (int i = 0; i < noPadBytes; i++) {
                    ...
                    if ((b = bytes.readByte()) != 0) {
                        LOG.warning("Padding byte != 0 in " + instructionType.getName() + ":" + b);
                    }
                }
            ...
            case Const.XXXUNUSEDXXX:
                // Format: xxxunusedxxx
                // Operand stack: ... -> ...
                LOG.info("Byte code contains unused operation (Ignored)");
                return new NoOperation();
