...
public class ArrayClass extends VClass {
    ...
    public void init(VClass intType) throws CompileException {
        ...
        get.alias="get";
        get.addArg(new VArgument("i", intType, false, false, null));
        ...
        set.alias="set";
        set.addArg(new VArgument("i", intType, false, false, null));
        set.addArg(new VArgument("v", component, false, false, null));
        ...
        constructor.addArg(new VArgument("l", intType, false, false, null));
